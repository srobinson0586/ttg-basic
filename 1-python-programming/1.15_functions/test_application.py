...
def functions():
    ...
    print('[+] setup_increment_counter Test PASSED')
    ...
    print('[+] increment_counter Test PASSED')
    ...
    print('[+] greet_person Test PASSED')
    ...
    print('[+] calculate_factorial Test PASSED')
