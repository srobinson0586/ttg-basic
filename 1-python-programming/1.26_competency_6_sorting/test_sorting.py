...
sample2 = [8, 1, 4, 3, 2, 5, 10, 7, 0, 9, 6]
...
def test_selection():
    assert sample1 != sorted_1, "See link: https://stackoverflow.com/a/38134344"
    select_rv = sorting.selection_sort(sample1)
    ...
    assert sample2 != sorted_2, "See link: https://stackoverflow.com/a/38134344"
    select_rv = sorting.selection_sort(sample2)
    ...
    assert sample3 != sorted_3, "See link: https://stackoverflow.com/a/38134344"
    select_rv = sorting.selection_sort(sample3)
    ...
    assert sample4 != sorted_4, "See link: https://stackoverflow.com/a/38134344"
    select_rv = sorting.selection_sort(sample4)
...
def test_merge():
    assert sample1 != sorted_1, "See link: https://stackoverflow.com/a/38134344"
    merge_rv = sorting.merge_sort(sample1)
    ...
    assert sample2 != sorted_2, "See link: https://stackoverflow.com/a/38134344"
    merge_rv = sorting.merge_sort(sample2)
    ...
    assert sample3 != sorted_3, "See link: https://stackoverflow.com/a/38134344"
    merge_rv = sorting.merge_sort(sample3)
    ...
    assert sample4 != sorted_4, "See link: https://stackoverflow.com/a/38134344"
    merge_rv = sorting.merge_sort(sample4)
