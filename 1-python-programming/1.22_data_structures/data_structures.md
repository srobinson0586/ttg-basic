...
Top --> Dragon Fruit
        ...
        Apples
```
You add elements to the top of the element using a `push()` function, and remove the top element with a `pop()` function.

When implementing a stack, you cannot `pop()` from an empty list. Check the top of the list using the `peek()` function before popping!
...
Elements within the Binary Tree are called nodes. Child Nodes are stored in the structure through comparison to a parent node. If the element in comparison is less than the parent node, it will be stored to the left of the parent node. If it is greater than the parent, it will be stored as the right child. Examples will be provided for each type of insertion.

### Example: 
We initialize our list with the number 21, and want to store the following numbers in our Binary Tree rooted with 21.
...
[More on BSTs](https://www.youtube.com/watch?v=pYT9F8_LFTM)
...
[Watch this video for the best explanation](https://www.youtube.com/watch?v=gXgEDyodOJU_)
...
[More on Linked Lists](https://www.youtube.com/watch?v=R9PTBwOzceo)

## Resources
- [YouTube | BST](https://www.youtube.com/watch?v=pYT9F8_LFTM)
- [YouTube | Graphs](https://www.youtube.com/watch?v=gXgEDyodOJU_)
- [YouTube | Linked Lists](https://www.youtube.com/watch?v=R9PTBwOzceo)
- [TutorialsPoint | Data Structures](https://www.tutorialspoint.com/data_structures_algorithms/data_structures_basics.htm)
