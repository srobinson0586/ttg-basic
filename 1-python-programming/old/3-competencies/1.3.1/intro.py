...
def dup_last_2(s, n):
    ...
    E.g.,
     ...
     dup_last_2('mocha', 3) -> 'hahaha' """    pass
...
def short_long_short(s1, s2):
    ...
    E.g.,
     ...
     shortlongshort('hi', 'a big string') -> 'hia big stringhi' """    pass
...
def adding(a, b):
    ...
    if they are, return twice their sum. """    pass
...
def tens(a, b):
    ...
    sum is 10; otherwise return False. """    pass

def hundreds(n):
    """ Given an integer `n`, return True if its difference from 100
    is less than or equal to 10. """    pass
...
def negatives(a, b, negative):
    ...
    Otherwise return False in both cases. """    pass
...
def sum_list(lst):
    ...
    all the built-in Python variables. """    pass
...
def rotate_2_spaces_left(lst):
    ...
    You may assume the list has at least 2 elements in it. """    pass
...
def append_product_and_sum(lst):
    ...
    E.g.,
     append_product_and_sum([1, 2, 3]) -> [1, 6, 7] """    pass
...
def count_trues(a, b, c):
    """ Given three booleans, return the number of them that are True. """    pass
...
def has_7_before_6(lst):
    ...
    before 7 or if there is no 7, return False. """    pass
...
def greater_than_both(a, b, c):
    ...
    `a` is greater than `c`. Otherwise, return False. """    pass
...
def copy_xkcd_to_calvin(lst):
    ...
    E.g.,
     ...
     -> ['cow', 'calvinabc', 'calvin ball', 'donkey'] """    pass
...
def even_odd_product(lst):
    ...
    E.g.,
     even_odd_product([1, 2, 3, 4, 6]) -> 48 (i.e., (2 + 4 + 6)*(1 + 3)) """    pass
...
def pop_while(lst):
    ...
    while `lst` is non-empty) and perform a `lst.pop` at each iteration. """    pass
