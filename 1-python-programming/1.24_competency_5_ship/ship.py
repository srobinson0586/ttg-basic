...
class Ship:
    ...
    Each Ship instance has the following attributes:
        ...
        - cls: str; The class of the ship.
        - location: tuple; In a two-element tuple, the x- and y-coordinates of the ship in nautical miles relative to where it started.
        - heading: float; The heading of the ship in degrees from North.
        - rudder_angle: float; The current angle of the rudder in degrees from center.
        - speed: float; The speed of the ship in knots.
        - engine_speed: float: The current speed of the engine in thousands of RPM. """
    ...
    def update(self, t_secs):
        ...
        ### the number of seconds we're turning for.        
        ### TODO: Update `self.heading` to be between 0 and 360 using the
        ### modulus operator.
