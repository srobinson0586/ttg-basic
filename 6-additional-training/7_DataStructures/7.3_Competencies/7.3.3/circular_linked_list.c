...
* 	params: 
*			node** list - address of the head of your circularly linked list
...
/*
* 	Removes the node from your circularly linked list
* 	params:
*			node** list - address of the head of your circularly linked list
*			node* del 	- the node you want to remove from the circularly linked list
*	returns:
...
/*
* 	Sorts the circularly linked list in ascending order.
* 	params:
*			node** list - address of the head of the circularly linked list
*	returns:
...
* 	params:
*			node** list 	- address of the head of the circularly linked list
*			node* n 		- the node to insert into the circularly linked list
*			int location 	- the location to add the node at
*	returns:
*			none - but the circularly linked list has changed to include the new node
*/
...
/*
* 	Completely destroys the circularly linked list
* 	params: 
*			node* list - pointer to head of the circularly linked list
*	returns: 
...
/*
* 	Prints the entire circularly linked list in order
* 	params:
*			node* list - head of the circularly linked list to print
*	returns:
